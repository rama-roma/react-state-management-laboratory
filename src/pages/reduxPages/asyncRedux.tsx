...
const AsyncRedux = () => {
  ...
  const [addImage, setAddImage] = useState<FileList | null>(null);
  ...
  const filteredData = data
    ...
    .filter((e) => {
      if (selected === "active") return e.isCompleted;
      if (selected === "inactive") return !e.isCompleted;
      return true;
    });
  ...
  return (
    <main className="p-6 min-h-screen">
      ...
      <Modal title="Add User" onOk={handleAdd} onCancel={() => setOpenAdd(false)} open={openAdd}>
      ...
      <Modal title="Edit User" onOk={handleEdit} onCancel={() => setOpenEdit(false)} open={openEdit}>
        <div className="flex flex-col gap-4">
          <Input
            placeholder="Name..."
            value={editName}
